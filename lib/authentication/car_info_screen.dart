...
class _CarInfoScreenState extends State<CarInfoScreen> {
  ...
  TextEditingController merkmobilTextEditingController = TextEditingController();
  TextEditingController platnomorTextEditingController = TextEditingController();
  TextEditingController warnamobilTextEditingController = TextEditingController();
  ...
  saveMobilInfo(){
    Map driverMobilInfoMap ={
        ...
        driverRef.child(currentFirebaseUser!.uid).child("detail_mobil").set(driverMobilInfoMap);
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 10,),
                ...
                ElevatedButton(
                  onPressed: (){
                    if(warnamobilTextEditingController.text.isNotEmpty && platnomorTextEditingController.text.isNotEmpty && merkmobilTextEditingController.text.isNotEmpty && selectedmerkMobil != null){
                      saveMobilInfo();
                    }
